...
from app.helpers.file_utils import get_json, save_json
from app.helpers.string_utils import get_comma_separated_names
from app.helpers.validation_utils import is_valid_date, parse_int, parse_bool_safe
    ...
    for index, row in df.iterrows():
        ...
        if project_id in VALID_REPOS:
            ...
            if db_repository:
                ...
                if crud.exits_tests_data_by_pipeline(db, db_pipeline.id):
                    ...
                    for m_row in m_file:
                        ...
                        if len(row_data) > 4:
                            ...
                            db_test_data = {
                                ...
                                "is_test_file": parse_bool_safe(row_data[2]),
                                "has_test_import": parse_bool_safe(row_data[3]),
                                "has_test_call": parse_bool_safe(row_data[4]),
                                "pipeline_id": db_pipeline.id,
